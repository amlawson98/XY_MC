...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;x=\frac{-\sum_0^{\langle ij\rangle}\beta_i\pm\sqrt{b^2-4ac}}{2a}" title="\Large x=\frac{-b\pm\sqrt{b^2-4ac}}{2a}" />
